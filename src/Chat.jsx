        ...
        <button
          onClick={async () => {
            ...
            try {
              ...
              if (res.ok || data.usuario) setUsuario(data.usuario || { nombre: nombreTemp.trim() });
...
// --- Estilos ---
const styles = {
  container: { maxWidth: 600, margin: "20px auto", padding: 15, fontFamily: "Arial, sans-serif", borderRadius: 10, boxShadow: "0px 5px 20px rgba(0,0,0,0.2)", backgroundColor: "#fff" },
  ...
  button: { padding: "8px 10px", borderRadius: 5, backgroundColor: "#4CAF50", color: "#fff", border: "none", cursor: "pointer", transition: "background-color 0.3s", flexShrink: 0 },
  buttonRechazar: { padding: "8px 10px", borderRadius: 5, backgroundColor: "#f44336", color: "#fff", border: "none", cursor: "pointer", transition: "background-color 0.3s", flexShrink: 0 },
  llamadaBox: { padding: 10, border: "1px solid green", borderRadius: 5, marginBottom: 10, backgroundColor: "#f0fff0", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 5 },
  userRow: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 5, marginBottom: 8, padding: 5, borderBottom: "1px dotted #eee", flexWrap: "wrap" },
  callButton: { padding: "5px 10px", borderRadius: 5, backgroundColor: "#2196F3", color: "#fff", border: "none", cursor: "pointer", display: "flex", alignItems: "center", transition: "background-color 0.3s", flexShrink: 0 },
  audioButton: { marginBottom: 10, padding: "8px", borderRadius: 5, backgroundColor: "#2196F3", color: "#fff", border: "none", cursor: "pointer" },
};
